...
export const SignUp = () => {
  ...
  const validation = (data) => {
    ...
    } else if (!name || name.length==='' || name.length < 2 || name.length > 40 || !nameFormat) {
      err.name = "Enter Valid Name";
    } else if (!email || !emailFormat) {
      err.email = "Enter Valid Email ID";
    } else if (phonenumberFormat === false || phone.length<10 || phone.length>10) {
          ...
          <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-3 m-4  ">
            ...
            <div className="md:block hidden w-1/2 ">
              <img
                ...
                src="https://img.freepik.com/free-vector/privacy-policy-concept-illustration_114360-7853.jpg?w=740&t=st=1685006033~exp=1685006633~hmac=905528629e819b595c88e709e67a37a59b230416d2f782cce46ebe547c18560e"
                alt="signup"
              />
            </div>
          </div>
